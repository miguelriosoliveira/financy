...
import { CATEGORY_ICONS, CATEGORY_LABELS, type CategoryType } from './category-icon';
...
export function IconSelector({ value, onChange }: Props) {
	return <OptionSelector label="Ícone" value={value} onChange={onChange} options={ICON_OPTIONS} />;
}
